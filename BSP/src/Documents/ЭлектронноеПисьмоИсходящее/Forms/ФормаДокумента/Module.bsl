...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() Тогда
		...
		//Если  ТипЗнч(Параметры.Предмет) = Тип("ДокументСсылка._ЗаявкаНаОплату")     Тогда
		//Объект.ВзаимодействиеОснование =Параметры.Предмет;
		//КонецЕсли; 	
		//КонецЕсли;
	...
	//Санчес
	Если    Параметры.Свойство("ОтправитьПриОткрытии") Тогда
    ОтправитьПриОткрытии =Параметры.ОтправитьПриОткрытии;
	КонецЕсли;
КонецПроцедуры
...
Процедура ПриОткрытии(Отказ)
	...
	// Санчес
	Если  ОтправитьПриОткрытии Тогда	
	ОтправитьПереслатьВыполнить(Неопределено);
