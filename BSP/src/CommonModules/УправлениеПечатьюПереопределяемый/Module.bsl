...
//Санчес 
СписокОбъектов.Добавить(Документы._ЗаявкаНаОплату);
СписокОбъектов.Добавить(Документы._КалендарныеПлатежи);
...
Процедура ПечатьДокументовПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Надпись.Заголовок = СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(
